...
module.exports = function(app) {
	app.post('/increase-volume/:name.' + config.default_audio_format, function(req, res) {
		...
		if (filepath) {
			...
			fs.rename(filepath, config.audio_file_path_increase_volume + '/' + req.params.name + '.' + config.default_audio_format);
