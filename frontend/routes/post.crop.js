...
module.exports = function(app) {
	app.post('/crop/:name.' + config.default_audio_format, function(req, res) {
		...
		if (filepath) {
			...
			var newAudioPath = config.audio_file_path_crop + '/start-' + req.body.start + '-stop-' + req.body.end + '-' + req.params.name + '.' + config.default_audio_format;
