...
"use strict";WaveSurfer.Regions={init:function(e){this.wavesurfer=e,this.wrapper=this.wavesurfer.drawer.wrapper,this.list={}},add:function(e){var t=Object.create(WaveSurfer.Region);return t.init(e,this.wavesurfer),this.list[t.id]=t,t.on("remove",function(){delete this.list[t.id]}.bind(this)),t},clear:function(){Object.keys(this.list).forEach(function(e){this.list[e].remove()},this)},enableDragSelection:function(e){function t(e){n=!0,"undefined"!=typeof e.targetTouches&&1===e.targetTouches.length&&(e.clientX=e.targetTouches[0].clientX),s=o.wavesurfer.drawer.handleEvent(e),a=null}function i(e){n=!1,a&&(a.fireEvent("update-end",e),o.wavesurfer.fireEvent("region-update-end",a,e)),a=null}function r(t){if(n){a||(a=o.add(e||{}));var i=o.wavesurfer.getDuration();"undefined"!=typeof t.targetTouches&&1===t.targetTouches.length&&(t.clientX=t.targetTouches[0].clientX);var r=o.wavesurfer.drawer.handleEvent(t);a.update({start:Math.min(r*i,s*i),end:Math.max(r*i,s*i)})}}var n,s,a,o=this;this.wrapper.addEventListener("mousedown",t),this.wrapper.addEventListener("touchstart",t),this.wrapper.addEventListener("mouseup",i),this.wrapper.addEventListener("touchend",i),this.wrapper.addEventListener("mousemove",r),this.wrapper.addEventListener("touchmove",r)}},WaveSurfer.Region={style:WaveSurfer.Drawer.style,init:function(e,t){this.wavesurfer=t,this.wrapper=t.drawer.wrapper,this.id=null==e.id?WaveSurfer.util.getId():e.id,this.start=Number(e.start)||0,this.end=null==e.end?this.start+4/this.wrapper.scrollWidth*this.wavesurfer.getDuration():Number(e.end),this.resize=void 0===e.resize?!0:Boolean(e.resize),this.drag=void 0===e.drag?!0:Boolean(e.drag),this.loop=Boolean(e.loop),this.color=e.color||"rgba(0, 0, 0, 0.1)",this.data=e.data||{},this.attributes=e.attributes||{},this.maxLength=e.maxLength,this.minLength=e.minLength,this.bindInOut(),this.render(),this.wavesurfer.on("zoom",this.updateRender.bind(this)),this.wavesurfer.fireEvent("region-created",this)},update:function(e){null!=e.start&&(this.start=Number(e.start)),null!=e.end&&(this.end=Number(e.end)),null!=e.loop&&(this.loop=Boolean(e.loop)),null!=e.color&&(this.color=e.color),null!=e.data&&(this.data=e.data),null!=e.resize&&(this.resize=Boolean(e.resize)),null!=e.drag&&(this.drag=Boolean(e.drag)),null!=e.maxLength&&(this.maxLength=Number(e.maxLength)),null!=e.minLength&&(this.minLength=Number(e.minLength)),null!=e.attributes&&(this.attributes=e.attributes),this.updateRender(),this.fireEvent("update"),this.wavesurfer.fireEvent("region-updated",this)},remove:function(e){this.element&&(this.wrapper.removeChild(this.element),this.element=null,this.fireEvent("remove"),this.wavesurfer.un("zoom",this.updateRender.bind(this)),this.wavesurfer.fireEvent("region-removed",this))},play:function(){this.wavesurfer.play(this.start,this.end),this.fireEvent("play"),this.wavesurfer.fireEvent("region-play",this)},playLoop:function(){this.play(),this.once("out",this.playLoop.bind(this))},render:function(){var e=document.createElement("region");e.className="wavesurfer-region",e.title=this.formatTime(this.start,this.end),e.setAttribute("data-id",this.id);for(var t in this.attributes)e.setAttribute("data-region-"+t,this.attributes[t]);this.wrapper.scrollWidth;if(this.style(e,{position:"absolute",zIndex:2,height:"100%",top:"0px"}),this.resize){var i=e.appendChild(document.createElement("handle")),r=e.appendChild(document.createElement("handle"));i.className="wavesurfer-handle wavesurfer-handle-start",r.className="wavesurfer-handle wavesurfer-handle-end";var n={cursor:"col-resize",position:"absolute",left:"0px",top:"0px",width:"1%",maxWidth:"4px",height:"100%"};this.style(i,n),this.style(r,n),this.style(r,{left:"100%"})}this.element=this.wrapper.appendChild(e),this.updateRender(),this.bindEvents(e)},formatTime:function(e,t){return(e==t?[e]:[e,t]).map(function(e){return[Math.floor(e%3600/60),("00"+Math.floor(e%60)).slice(-2)].join(":")}).join("-")},updateRender:function(){var e=this.wavesurfer.getDuration(),t=this.wrapper.scrollWidth;if(this.start<0&&(this.start=0,this.end=this.end-this.start),this.end>e&&(this.end=e,this.start=e-(this.end-this.start)),null!=this.minLength&&(this.end=Math.max(this.start+this.minLength,this.end)),null!=this.maxLength&&(this.end=Math.min(this.start+this.maxLength,this.end)),null!=this.element){this.style(this.element,{left:~~(this.start/e*t)+"px",width:~~((this.end-this.start)/e*t)+"px",backgroundColor:this.color,cursor:this.drag?"move":"default"});for(var i in this.attributes)this.element.setAttribute("data-region-"+i,this.attributes[i]);this.element.title=this.formatTime(this.start,this.end)}},bindInOut:function(){var e=this;e.firedIn=!1,e.firedOut=!1;var t=function(t){!e.firedIn&&e.start<=t&&e.end>t&&(e.firedIn=!0,e.firedOut=!1,e.fireEvent("in"),e.wavesurfer.fireEvent("region-in",e)),!e.firedOut&&e.firedIn&&(e.start>=Math.round(100*t)/100||e.end<=Math.round(100*t)/100)&&(e.firedOut=!0,e.firedIn=!1,e.fireEvent("out"),e.wavesurfer.fireEvent("region-out",e))};this.wavesurfer.backend.on("audioprocess",t),this.on("remove",function(){e.wavesurfer.backend.un("audioprocess",t)}),this.on("out",function(){e.loop&&e.wavesurfer.play(e.start)})},bindEvents:function(){var e=this;this.element.addEventListener("mouseenter",function(t){e.fireEvent("mouseenter",t),e.wavesurfer.fireEvent("region-mouseenter",e,t)}),this.element.addEventListener("mouseleave",function(t){e.fireEvent("mouseleave",t),e.wavesurfer.fireEvent("region-mouseleave",e,t)}),this.element.addEventListener("click",function(t){t.preventDefault(),e.fireEvent("click",t),e.wavesurfer.fireEvent("region-click",e,t)}),this.element.addEventListener("dblclick",function(t){t.stopPropagation(),t.preventDefault(),e.fireEvent("dblclick",t),e.wavesurfer.fireEvent("region-dblclick",e,t)}),(this.drag||this.resize)&&function(){var t,i,r,n=e.wavesurfer.getDuration(),s=function(s){s.stopPropagation(),r=e.wavesurfer.drawer.handleEvent(s)*n,"handle"==s.target.tagName.toLowerCase()?i=s.target.classList.contains("wavesurfer-handle-start")?"start":"end":t=!0},a=function(r){(t||i)&&(t=!1,i=!1,r.stopPropagation(),r.preventDefault(),e.fireEvent("update-end",r),e.wavesurfer.fireEvent("region-update-end",e,r))},o=function(s){if(t||i){var a=e.wavesurfer.drawer.handleEvent(s)*n,o=a-r;r=a,e.drag&&t&&e.onDrag(o),e.resize&&i&&e.onResize(o,i)}};e.element.addEventListener("mousedown",s),e.wrapper.addEventListener("mousemove",o),document.body.addEventListener("mouseup",a),e.on("remove",function(){document.body.removeEventListener("mouseup",a),e.wrapper.removeEventListener("mousemove",o)}),e.wavesurfer.on("destroy",function(){document.body.removeEventListener("mouseup",a)})}()},onDrag:function(e){this.update({start:this.start+e,end:this.end+e})},onResize:function(e,t){"start"==t?this.update({start:Math.min(this.start+e,this.end),end:Math.max(this.start+e,this.end)}):this.update({start:Math.min(this.end+e,this.start),end:Math.max(this.end+e,this.start)})}},WaveSurfer.util.extend(WaveSurfer.Region,WaveSurfer.Observer),WaveSurfer.initRegions=function(){this.regions||(this.regions=Object.create(WaveSurfer.Regions),this.regions.init(this))},WaveSurfer.addRegion=function(e){return this.initRegions(),this.regions.add(e)},WaveSurfer.clearRegions=function(){this.regions&&this.regions.clear()},WaveSurfer.enableDragSelection=function(e){this.initRegions(),this.regions.enableDragSelection(e)};
var audioDuration=null,audioProcess=null,concatAllVideos=!1,deleteDialogShown=!1,deletionTr=null,fileUrl=null,frameProcess=null,infoArea=null,lastInfoText=null,loaded=!1,noiseFilterUrl=null,markerRegion=null,previewModeEnabled=!1,shiftKeyPressed=!1,skipFocusRemove=!1,videoUrl=null,wavesurfer=Object.create(WaveSurfer);$(document).ready(function(){$(".btn-reload").click(function(){location.reload()}),$(".btn-import").click(function(){location.href="/import"}),initWavesurfer(),initAudio(),initButtons(),initInfoArea(),initTextManager(),initVideoList(),initTooltips(),initLogsPage(),initShotcuts(),initStatusPage(),initImportPage(),initTableTools(),initNoiseFilterList(),startUpdateRecordingState()});var deleteCurrentFile=function(){$.ajax({url:fileUrl,type:"DELETE",success:function(e){if(deletionTr){var o=deletionTr.parent().find("tr").length,t=deletionTr.next();if(deletionTr.remove(),t.find("td").eq(0).hasClass("img")&&(t.remove(),--o),deletionTr=null,1>=o)reloadPage();else{var a=$("audio").eq(0);a&&a[0].play()}}else reloadPage()}})},startUpdateRecordingState=function(){window.setInterval(function(){$.get("/api/is-recording.json",function(e){var o=JSON.parse(e),t=$("#main-navbar .microphone"),a=o.isRecording||!1;a?t.attr("title",stateRecording).removeClass("text-danger fa-microphone-slash").addClass("text-success fa-microphone"):t.attr("title",stateNotRecording).removeClass("text-success fa-microphone").addClass("text-danger fa-microphone-slash")})},5e3)},banNoise=function(){loaded&&(markerRegion?$("#ban-noise-modal").modal("show"):$("#set-marker-first-3-error").modal("show"))},cropToMarker=function(){loaded&&(markerRegion?$("#crop-to-marker-modal").modal("show"):$("#set-marker-first-3-error").modal("show"))},jumpToMarker=function(){if(loaded)if(markerRegion){var e=markerRegion.start/audioDuration;wavesurfer.stop(),wavesurfer.seekTo(e)}else $("#set-marker-first-2-error").modal("show")},playFromMarker=function(){if(loaded)if(markerRegion){var e=markerRegion.start/audioDuration;wavesurfer.seekTo(e),wavesurfer.play()}else $("#set-marker-first-error").modal("show")},setMarker=function(){if(loaded)if(null===markerRegion){var e=audioDuration-1;if(e>audioProcess){$(this).find(".text").text("Remove marker");var o={start:audioProcess,end:e};markerRegion=wavesurfer.addRegion(o),console.log("Marker set to:",markerRegion)}}else markerRegion.remove(),markerRegion=null,$(this).find(".text").text("Set marker")},initAudio=function(){var e=$("audio");e.on("play",function(){e.not(this).each(function(e,o){o.pause()})})},initTableTools=function(){$("table th input[type=checkbox]").click(function(){$(this).parents("table").find("td input[type=checkbox]").each(function(){var e=$(this);e.prop("checked",!e.prop("checked"))})})},initImportPage=function(){$("#force-import").click(function(){$("#force-import-modal").modal("show")}),$("#force-import-confirm").click(function(){$.ajax({url:"/force-import",type:"POST",success:function(e){$("#force-import-done").modal("show")}})}),$("#upload-file").click(function(){$("#upload-file-modal").modal("show")}),$("#upload-file-submit").click(function(){return $("#upload-form").submit(),!1})},initStatusPage=function(){$("#file-system,#overview-list").on("click",".delete",function(e){console.log("Shift key down",shiftKeyPressed);var o=$(this),t=getVideoPathForClickedButton(o);fileUrl=t,deletionTr=o.parents("tr"),shiftKeyPressed?deleteCurrentFile():$("#delete-file").modal("show")}),$("#delete-status-file-confirm").click(function(){console.log("Delete button pressed: ",fileUrl);var e=fileUrl.replace("/usr/sleeptalk/",""),o=e.split("/");console.log("Urls",e,o),o.length>=2&&$.ajax({url:"/file/"+o[0]+"/"+o[1],type:"DELETE",success:function(e){if(deletionTr){var o=deletionTr.parent(),t=o.find("tr").length;2>=t&&deletionTr.parent().find("tr.hidden").show(),deletionTr.remove(),deletionTr=null}else reloadPage()}})})},initShotcuts=function(){$("#shortcut-help").click(function(){$("#shortcut-help-modal").modal("show")}),$(document).keydown(function(e){var o=e.target.tagName.toLowerCase();if("input"!=o&&"textarea"!=o)if(console.log("Keydown",e,e.which),!loaded||e.metaKey||e.altKey||e.ctrlKey||e.shiftKey){if(e.shiftKey)switch(shiftKeyPressed=!0,e.which){case 68:console.log("D key down"),deleteCurrentFile()}}else switch(e.which){case 27:wavesurfer.stop();break;case 32:wavesurfer.playPause();break;case 37:wavesurfer.skip(-5);break;case 38:wavesurfer.skip(-10);break;case 39:wavesurfer.skip(5);break;case 40:wavesurfer.skip(10);break;case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:var t=(e.which-48)/100,a=audioDuration*t;wavesurfer.seekTo(a);break;case 66:banNoise();break;case 67:cropToMarker();break;case 68:$("#delete-file").modal("show");break;case 70:togglePreview();break;case 74:jumpToMarker();break;case 77:setMarker();break;case 80:playFromMarker()}}).keyup(function(e){var o=e.target.tagName.toLowerCase();"input"!=o&&"textarea"!=o&&(console.log("Keyup",e,e.which),16==e.which&&(shiftKeyPressed=!1))})},initInfoArea=function(){infoArea=$("#info-area"),window.setInterval(updateInfoArea,50)},initWavesurfer=function(){var e=$("#wave");if(e&&e.length>0){wavesurfer.init({container:"#wave-content",height:400,progressColor:"#0B486B",normalize:!0,waveColor:"#3B8686"});var o=e.attr("file-to-process");fileUrl="/"+o+"."+defaultAudioFormat,console.log("wav url: ",fileUrl),fileUrl&&fileUrl.length>0&&(wavesurfer.on("ready",function(){audioDuration=wavesurfer.getDuration(),$("#wave-content").animate({opacity:1},250,function(){wavesurfer.play(),loaded=!0}),$("#wave-loading").fadeOut(250)}),wavesurfer.on("audioprocess",function(e){audioProcess=e,frameProcess=Math.round(15*audioProcess),previewModeEnabled&&$("#text-manager tbody tr").each(function(){var e=$(this),o=parseInt(e.find("input.frame").val(),10),t=e.find("input.text").val();o&&o>0&&t&&t.length>0&&frameProcess>=o&&(console.log("sgsdg",t),$("#wave-preview-overlay").text(t))})}),wavesurfer.on("seek",function(e){audioProcess=audioDuration*e,frameProcess=Math.round(15*audioProcess),$("#wave-preview-overlay").text(""),skipFocusRemove?skipFocusRemove=!1:$(":focus").blur()}),wavesurfer.on("stop",function(){$("#wave-preview-overlay").text("")}),wavesurfer.on("finish",function(){$("body").addClass("playback-finished"),!deleteDialogShown&&autoShowDeleteDialog&&(deleteDialogShown=!0,$("#delete-file").modal("show"))}),wavesurfer.on("play",function(){$("#wave-play").attr("title",pauseButtonText).attr("data-original-title",pauseButtonText).find(".text").text(pauseButtonText).end().find(".fa").removeClass("fa-play").addClass("fa-pause")}),wavesurfer.on("pause",function(){$("#wave-play").attr("title",playButtonText).attr("data-original-title",playButtonText).find(".text").text(playButtonText).end().find(".fa").removeClass("fa-pause").addClass("fa-play")}),wavesurfer.load(fileUrl))}$("#clear-pending").click(function(){return $("#clear-pending-modal").modal("show"),!1}),$("#clear-pending-confirm").click(function(){$.ajax({url:"/",type:"DELETE",success:function(e){reloadPage()}})}),$("#text-manager tbody tr").on("keydown change keypress keyup","input.text",function(){console.log("gdsg");var e=$(this),o=e.parents("tr"),t=o.find("input.frame");0==t.val().length&&t.val(pad(frameProcess,4))})},togglePreview=function(){previewModeEnabled=!previewModeEnabled;var e=previewModeEnabled?disablePreviewButtonText:enablePreviewButtonText,o=previewModeEnabled?"eye-slash":"eye";$("#wave-preview").attr("title",e).attr("data-original-title",e).find(".text").text(e).end().find(".fa").removeClass("fa-eye fa-eye-slash").addClass("fa-"+o),previewModeEnabled?$("#wave-preview-overlay").show():$("#wave-preview-overlay").hide()},initButtons=function(){$("#wave-preview").click(function(){loaded&&togglePreview()}),$("#wave-playback-rate").click(function(){loaded&&$("#set-playback-rate-modal").modal("show")}),$("#set-playback-rate-confirm").click(function(){var e=$("#playback-rate").val();Number(parseFloat(e))==e&&wavesurfer.setPlaybackRate(e)}),$("#wave-step-backward").click(function(){loaded&&wavesurfer.skipBackward()}),$("#wave-play").click(function(){loaded&&wavesurfer.playPause()}),$("#wave-stop").click(function(){loaded&&wavesurfer.stop()}),$("#wave-step-forward").click(function(){loaded&&wavesurfer.skipForward()}),$("#wave-set-marker").click(setMarker),$("#wave-jump-to-marker").click(jumpToMarker),$("#wave-play-from-marker").click(playFromMarker),$("#wave-save").click(function(){if(loaded){$("#text-sort").click();var e=[];$("#text-manager tbody tr").each(function(){var o=$(this),t=o.find("input.frame").val(),a=o.find("input.text").val();if(t&&t.length>0&&a&&a.length>0){var r=t+"|"+a;e.push({content:r,frame:t})}}),e.sort(function(e,o){return e.frame<o.frame?-1:e.frame>o.frame?1:0});var o=[];for(var t in e){var a=e[t];o.push(a.content)}var r=o.join("\n");console.log("Final content",o),$.post(fileUrl,{content:r},function(){reloadPage()})}}),$("#wave-delete").click(function(){loaded&&$("#delete-file").modal("show")}),$("#delete-file-confirm").click(function(){deleteCurrentFile()}),$("#wave-decrease-volume").click(function(){$("#decrease-volume-modal").modal("show")}),$("#decrease-volume-confirm").click(function(){$.post("decrease-volume"+fileUrl,null,function(){reloadPage()})}),$("#wave-increase-volume").click(function(){$("#increase-volume-modal").modal("show")}),$("#increase-volume-confirm").click(function(){$.post("increase-volume"+fileUrl,null,function(){reloadPage()})}),$("#wave-crop-to-marker").click(cropToMarker),$("#crop-to-marker-confirm").click(function(){$.post("crop"+fileUrl,{end:markerRegion.end,start:markerRegion.start},function(){reloadPage()})}),$("#wave-ban-noise").click(banNoise),$("#ban-noise-confirm").click(function(){$.post("ban-noise"+fileUrl,{end:markerRegion.end,start:markerRegion.start},function(){$("#ban-noise-done-modal").modal("show")})})},updateInfoArea=function(){if(loaded){var e=[];audioProcess&&(e.push(audioProcess.toFixed(2)),e.push("("+frameProcess+")"),e.push("/")),e.push(audioDuration.toFixed(2)),e.push("- "+pendingFilesText+": "+fileCount);var o=e.join(" ");(null==lastInfoText||lastInfoText!=o)&&(lastInfoText=o,infoArea.text(o))}},initTooltips=function(){$(function(){$('[data-toggle="tooltip"]').tooltip()})},initLogsPage=function(){$("#clear-logs").click(function(){return $("#clear-logs-modal").modal("show"),!1}),$("#clear-logs-confirm").click(function(){$.ajax({url:"/logs",type:"DELETE",success:function(e){reloadPage()}})})},initTextManager=function(){var e=$(window).height(),o=$("#spectrum").outerHeight();$("#text-wrapper").css("maxHeight",e-572-o),$("#text-manager").on("click",".play",function(){var e=$(this),o=e.parents("tr"),t=o.find(".frame input"),a=t.val();if(console.log("Frames: ",a),a.length>0){var r=a/(15*audioDuration);console.log("Percent: ",r),wavesurfer.seekTo(r),wavesurfer.play()}else $("#set-frame-first-error").modal("show")}).on("click",".arrow-up",function(){var e=$(this),o=e.parents("tr"),t=o.prev();t.length>0&&o.insertBefore(t)}).on("click",".arrow-down",function(){var e=$(this),o=e.parents("tr"),t=o.next();t.length>0&&o.insertAfter(t)}).on("click",".arrow-left",function(){var e=$(this),o=e.parents("tr"),t=o.find("input.frame");t.val(pad(frameProcess,4))}).on("click",".delete",function(){var e=$(this),o=e.parents("tr"),t=o.parents("tbody"),a=t.find("tr");a.length>1?o.remove():o.find("input").val("")}).on("blur","input.frame",function(){var e=$(this);e.val(pad(Math.abs(parseInt(e.val())),4))}).on("blur change","input.text",function(){var e=$(this);e.val(e.val().replace(/\|/g,""))});var t=function(){var e=$("#text-manager tbody"),o=e.find("tr:first-child"),t=o.clone();t.find("input").val(""),t.appendTo(e),t.find("input").last().focus().end().first().val(pad(frameProcess,4))};$("#text-add").click(t),$("#wave").dblclick(function(){skipFocusRemove=!0,t()}),$("#text-clear").click(function(){$("#clear-texts").modal("show")}),$("#text-sort").click(function(){$("#text-manager tbody tr").sort(function(e,o){var t=$(e),a=$(o),r=t.find(".frame"),i=a.find(".frame");return parseInt(r.val())>parseInt(i.val())?1:-1}).appendTo("#text-manager tbody")}),$("#text-clear-confirm").click(function(){$("#text-manager tbody tr").find("input").val("").end().not(":first-child").remove(),$("#clear-texts").modal("hide")})},getVideoPathForClickedButton=function(e){var o=e.parents("tr"),t=o.find(".path"),a=t.text();return a},initNoiseFilterList=function(){$("#noise-filter-list").on("click",".delete",function(){var e=$(this),o=getVideoPathForClickedButton(e);noiseFilterUrl=o,console.log("Wav path",noiseFilterUrl),$("#delete-noise-filter").modal("show")}),$("#delete-noise-filter-confirm").click(function(){console.log("Delete button pressed: ",noiseFilterUrl),$.ajax({url:noiseFilterUrl,type:"DELETE",success:function(e){$.ajax({url:noiseFilterUrl.replace(".prof",""),type:"DELETE",success:function(e){reloadPage()}})}})})},initVideoList=function(){$("#concat-checked-videos").click(function(){concatAllVideos=!1,$("#concat-videos-modal").modal("show")}),$("#concat-all-videos").click(function(){concatAllVideos=!0,$("#concat-videos-modal").modal("show")}),$("#concat-videos-confirm").click(function(){var e=[];$("#video-list td input[type=checkbox]").each(function(o,t){var a=$(this);if(concatAllVideos||a.is(":checked")){var r=a.val();e.push(r)}}),$.ajax({url:"/concat-videos",type:"POST",data:{movieTitle:$("#movie-title").val(),videos:e},success:function(e){$("#movie-title").val(""),reloadPage()}})}),$("#video-list").on("click",".download",function(){console.log("Download button pressed");var e=$(this),o=getVideoPathForClickedButton(e);location.href="/download/"+o}).on("click",".play",function(){console.log("Play button pressed");var e=$(this),o=getVideoPathForClickedButton(e),t=$("#video-target");t.find("video").remove();var a=$("<video></video>").addClass("embed-responsive-item").attr("controls","controls").attr("autoplay","autoplay"),r=$("<source></source>").attr("type","video/"+defaultVideoFormat).attr("src",o);r.appendTo(a),a.appendTo(t),$("#play-video").modal("show")}).on("click",".delete",function(){var e=$(this),o=getVideoPathForClickedButton(e);videoUrl=o,$("#delete-video").modal("show")}),$("#delete-video-confirm").click(function(){console.log("Delete button pressed: ",videoUrl),$.ajax({url:videoUrl,type:"DELETE",success:function(e){reloadPage()}})}),$("#play-video").on("click","button",function(){console.log("Footer button pressed");var e=$("#video-target video");console.log("Videos: ",e),e&&e.length>0&&(e[0].paused||e[0].pause())})},pad=function(e,o){for(var t=e+"";t.length<o;)t="0"+t;return t},reloadPage=function(){console.log("Page reload scheduled"),window.setTimeout(function(){console.log("Reloading page"),location.reload()},1e3)};