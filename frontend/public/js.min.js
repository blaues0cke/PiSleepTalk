...
var audioDuration=null,audioProcess=null,concatAllVideos=!1,fileUrl=null,frameProcess=null,infoArea=null,lastInfoText=null,loaded=!1,noiseFilterUrl=null,markerRegion=null,videoUrl=null,wavesurfer=Object.create(WaveSurfer);$(document).ready(function(){$(".btn-reload").click(function(){location.reload()}),initWavesurfer(),initButtons(),initInfoArea(),initTextManager(),initVideoList(),initTooltips(),initLogsPage(),initShotcuts(),initStatusPage(),initImportPage(),initTableTools(),initNoiseFilterList()});var banNoise=function(){loaded&&(markerRegion?$("#ban-noise-modal").modal("show"):$("#set-marker-first-3-error").modal("show"))},cropToMarker=function(){loaded&&(markerRegion?$("#crop-to-marker-modal").modal("show"):$("#set-marker-first-3-error").modal("show"))},jumpToMarker=function(){if(loaded)if(markerRegion){var e=markerRegion.start/audioDuration;wavesurfer.stop(),wavesurfer.seekTo(e)}else $("#set-marker-first-2-error").modal("show")},playFromMarker=function(){if(loaded)if(markerRegion){var e=markerRegion.start/audioDuration;wavesurfer.seekTo(e),wavesurfer.play()}else $("#set-marker-first-error").modal("show")},setMarker=function(){if(loaded)if(null===markerRegion){var e=audioDuration-1;if(e>audioProcess){$(this).find(".text").text("Remove marker");var o={start:audioProcess,end:e};markerRegion=wavesurfer.addRegion(o),console.log("Marker set to:",markerRegion)}}else markerRegion.remove(),markerRegion=null,$(this).find(".text").text("Set marker")},initTableTools=function(){$("table th input[type=checkbox]").click(function(){$(this).parents("table").find("td input[type=checkbox]").each(function(){var e=$(this);e.prop("checked",!e.prop("checked"))})})},initImportPage=function(){$("#force-import").click(function(){$("#force-import-modal").modal("show")}),$("#force-import-confirm").click(function(){$.ajax({url:"/force-import",type:"POST",success:function(e){$("#force-import-done").modal("show")}})}),$("#upload-file").click(function(){$("#upload-file-modal").modal("show")}),$("#upload-file-submit").click(function(){return $("#upload-form").submit(),!1})},initStatusPage=function(){$("#file-system,#overview-list").on("click",".delete",function(){var e=$(this),o=getVideoPathForClickedButton(e);fileUrl=o,$("#delete-file").modal("show")}),$("#delete-status-file-confirm").click(function(){console.log("Delete button pressed: ",fileUrl);var e=fileUrl.replace("/usr/sleeptalk/",""),o=e.split("/");console.log("Urls",e,o),o.length>=2&&$.ajax({url:"/file/"+o[0]+"/"+o[1],type:"DELETE",success:function(e){reloadPage()}})})},initShotcuts=function(){$("#shortcut-help").click(function(){$("#shortcut-help-modal").modal("show")}),$(document).keydown(function(e){var o=e.target.tagName.toLowerCase();if(loaded&&"input"!=o&&"textarea"!=o)switch(console.log("Keydown",e,e.which),e.which){case 32:wavesurfer.playPause();break;case 37:wavesurfer.skip(-5);break;case 38:wavesurfer.skip(-10);break;case 39:wavesurfer.skip(5);break;case 40:wavesurfer.skip(10);break;case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:var a=(e.which-48)/100,t=audioDuration*a;wavesurfer.seekTo(t);break;case 66:banNoise();break;case 67:cropToMarker();break;case 74:jumpToMarker();break;case 77:setMarker();break;case 80:playFromMarker()}})},initInfoArea=function(){infoArea=$("#info-area"),window.setInterval(updateInfoArea,50)},initWavesurfer=function(){var e=$("#wave");if(e&&e.length>0){wavesurfer.init({container:"#wave-content",height:400,progressColor:"#0B486B",normalize:!0,waveColor:"#3B8686"});var o=e.attr("file-to-process");fileUrl="/"+o+"."+default_audio_format,console.log("wav url: ",fileUrl),fileUrl&&fileUrl.length>0&&(wavesurfer.on("ready",function(){audioDuration=wavesurfer.getDuration(),$("#wave-content").animate({opacity:1},250,function(){wavesurfer.play(),loaded=!0}),$("#wave-loading").fadeOut(250)}),wavesurfer.on("audioprocess",function(e){audioProcess=e,frameProcess=Math.round(15*audioProcess)}),wavesurfer.on("seek",function(e){audioProcess=audioDuration*e,frameProcess=Math.round(15*audioProcess)}),wavesurfer.on("play",function(){$("#wave-play").attr("title","Pause").attr("data-original-title","Pause").find(".text").text("Pause").end().find(".fa").removeClass("fa-play").addClass("fa-pause")}),wavesurfer.on("pause",function(){$("#wave-play").attr("title","Play").attr("data-original-title","Play").find(".text").text("Play").end().find(".fa").removeClass("fa-pause").addClass("fa-play")}),wavesurfer.load(fileUrl))}},initButtons=function(){$("#wave-step-backward").click(function(){loaded&&wavesurfer.skipBackward()}),$("#wave-play").click(function(){loaded&&wavesurfer.playPause()}),$("#wave-stop").click(function(){loaded&&wavesurfer.stop()}),$("#wave-step-forward").click(function(){loaded&&wavesurfer.skipForward()}),$("#wave-set-marker").click(setMarker),$("#wave-jump-to-marker").click(jumpToMarker),$("#wave-play-from-marker").click(playFromMarker),$("#wave-save").click(function(){if(loaded){$("#text-sort").click();var e=[];$("#text-manager tbody tr").each(function(){var o=$(this),a=o.find("input.frame").val(),t=o.find("input.text").val();if(a&&a.length>0&&t&&t.length>0){var r=a+"|"+t;e.push({content:r,frame:a})}}),e.sort(function(e,o){return e.frame<o.frame?-1:e.frame>o.frame?1:0});var o=[];for(var a in e){var t=e[a];o.push(t.content)}var r=o.join("\n");console.log("Final content",o),$.post(fileUrl,{content:r},function(){reloadPage()})}}),$("#wave-delete").click(function(){loaded&&$("#delete-file").modal("show")}),$("#delete-file-confirm").click(function(){$.ajax({url:fileUrl,type:"DELETE",success:function(e){reloadPage()}})}),$("#wave-decrease-volume").click(function(){$("#decrease-volume-modal").modal("show")}),$("#decrease-volume-confirm").click(function(){$.post("decrease-volume"+fileUrl,null,function(){reloadPage()})}),$("#wave-increase-volume").click(function(){$("#increase-volume-modal").modal("show")}),$("#increase-volume-confirm").click(function(){$.post("increase-volume"+fileUrl,null,function(){reloadPage()})}),$("#wave-crop-to-marker").click(cropToMarker),$("#crop-to-marker-confirm").click(function(){$.post("crop"+fileUrl,{end:markerRegion.end,start:markerRegion.start},function(){reloadPage()})}),$("#wave-ban-noise").click(banNoise),$("#ban-noise-confirm").click(function(){$.post("ban-noise"+fileUrl,{end:markerRegion.end,start:markerRegion.start},function(){$("#ban-noise-done-modal").modal("show")})})},updateInfoArea=function(){if(loaded){var e=[];audioProcess&&(e.push(audioProcess.toFixed(2)),e.push("("+frameProcess+")"),e.push("/")),e.push(audioDuration.toFixed(2)),e.push("- Pending files: "+fileCount);var o=e.join(" ");(null==lastInfoText||lastInfoText!=o)&&(lastInfoText=o,infoArea.text(o))}},initTooltips=function(){$(function(){$('[data-toggle="tooltip"]').tooltip()})},initLogsPage=function(){$("#clear-logs").click(function(){return $("#clear-logs-modal").modal("show"),!1}),$("#clear-logs-confirm").click(function(){$.ajax({url:"/logs",type:"DELETE",success:function(e){reloadPage()}})})},initTextManager=function(){var e=$(window).height();$("#text-wrapper").css("maxHeight",e-572),$("#text-manager").on("click",".arrow-up",function(){var e=$(this),o=e.parents("tr"),a=o.prev();a.length>0&&o.insertBefore(a)}).on("click",".arrow-down",function(){var e=$(this),o=e.parents("tr"),a=o.next();a.length>0&&o.insertAfter(a)}).on("click",".arrow-left",function(){var e=$(this),o=e.parents("tr"),a=o.find("input.frame");a.val(pad(frameProcess,4))}).on("click",".delete",function(){var e=$(this),o=e.parents("tr"),a=o.parents("tbody"),t=a.find("tr");t.length>1?o.remove():o.find("input").val("")}).on("blur","input.frame",function(){var e=$(this);e.val(pad(Math.abs(parseInt(e.val())),4))}).on("blur keydown keyup keypress","input.text",function(){var e=$(this);e.val(e.val().replace(/\|/g,""))});var o=function(){var e=$("#text-manager tbody"),o=e.find("tr:first-child"),a=o.clone();a.find("input").val(""),a.appendTo(e),a.find("input").last().focus().end().first().val(pad(frameProcess,4))};$("#text-add").click(o),$("#wave").dblclick(o),$("#text-clear").click(function(){$("#clear-texts").modal("show")}),$("#text-sort").click(function(){$("#text-manager tbody tr").sort(function(e,o){var a=$(e),t=$(o),r=a.find(".frame"),i=t.find(".frame");return parseInt(r.val())>parseInt(i.val())?1:-1}).appendTo("#text-manager tbody")}),$("#text-clear-confirm").click(function(){$("#text-manager tbody tr").find("input").val("").end().not(":first-child").remove(),$("#clear-texts").modal("hide")})},getVideoPathForClickedButton=function(e){var o=e.parents("tr"),a=o.find(".path"),t=a.text();return t},initNoiseFilterList=function(){$("#noise-filter-list").on("click",".delete",function(){var e=$(this),o=getVideoPathForClickedButton(e);noiseFilterUrl=o,console.log("Wav path",noiseFilterUrl),$("#delete-noise-filter").modal("show")}),$("#delete-noise-filter-confirm").click(function(){console.log("Delete button pressed: ",noiseFilterUrl),$.ajax({url:noiseFilterUrl,type:"DELETE",success:function(e){$.ajax({url:noiseFilterUrl.replace(".prof",""),type:"DELETE",success:function(e){reloadPage()}})}})})},initVideoList=function(){$("#concat-checked-videos").click(function(){concatAllVideos=!1,$("#concat-videos-modal").modal("show")}),$("#concat-all-videos").click(function(){concatAllVideos=!0,$("#concat-videos-modal").modal("show")}),$("#concat-videos-confirm").click(function(){var e=[];$("#video-list td input[type=checkbox]").each(function(o,a){var t=$(this);if(concatAllVideos||t.is(":checked")){var r=t.val();e.push(r)}}),$.ajax({url:"/concat-videos",type:"POST",data:{movieTitle:$("#movie-title").val(),videos:e},success:function(e){$("#movie-title").val(""),reloadPage()}})}),$("#video-list").on("click",".download",function(){console.log("Download button pressed");var e=$(this),o=getVideoPathForClickedButton(e);location.href="/download/"+o}).on("click",".play",function(){console.log("Play button pressed");var e=$(this),o=getVideoPathForClickedButton(e),a=$("#video-target");a.find("video").remove();var t=$("<video></video>").addClass("embed-responsive-item").attr("controls","controls").attr("autoplay","autoplay"),r=$("<source></source>").attr("type","video/"+default_video_format).attr("src",o);r.appendTo(t),t.appendTo(a),$("#play-video").modal("show")}).on("click",".delete",function(){var e=$(this),o=getVideoPathForClickedButton(e);videoUrl=o,$("#delete-video").modal("show")}),$("#delete-video-confirm").click(function(){console.log("Delete button pressed: ",videoUrl),$.ajax({url:videoUrl,type:"DELETE",success:function(e){reloadPage()}})}),$("#play-video").on("click","button",function(){console.log("Footer button pressed");var e=$("#video-target video");console.log("Videos: ",e),e&&e.length>0&&(e[0].paused||e[0].pause())})},pad=function(e,o){for(var a=e+"";a.length<o;)a="0"+a;return a},reloadPage=function(){console.log("Page reload scheduled"),window.setTimeout(function(){console.log("Reloading page"),location.reload()},1e3)};