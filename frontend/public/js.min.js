...
var audioDuration=null,audioFileExtension=".wav",audioProcess=null,fileUrl=null,frameProcess=null,infoArea=null,lastInfoText=null,loaded=!1,markerRegion=null,videoFileExtension=".mp4",videoUrl=null,wavesurfer=Object.create(WaveSurfer);$(document).ready(function(){$(".btn-reload").click(function(){location.reload()}),initWavesurfer(),initButtons(),initInfoArea(),initTextManager(),initVideoList(),initTooltips(),initLogsPage(),initShotcuts()});var initShotcuts=function(){$("#shortcut-help").click(function(){$("#shortcut-help-modal").modal("show")}),$(document).keydown(function(e){var a=e.target.tagName.toLowerCase();if(loaded&&"input"!=a&&"textarea"!=a)switch(console.log("Keydown",e,e.which),e.which){case 32:wavesurfer.playPause();break;case 37:wavesurfer.skip(-5);break;case 38:wavesurfer.skip(-10);break;case 39:wavesurfer.skip(5);break;case 40:wavesurfer.skip(10);break;case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:var o=(e.which-48)/100,t=audioDuration*o;wavesurfer.seekTo(t)}})},initInfoArea=function(){infoArea=$("#info-area"),window.setInterval(updateInfoArea,50)},initWavesurfer=function(){var e=$("#wave");if(e&&e.length>0){wavesurfer.init({container:"#wave-content",height:400,progressColor:"#0B486B",normalize:!0,waveColor:"#3B8686"});var a=e.attr("file-to-process");fileUrl="/"+a+audioFileExtension,console.log("wav url: ",fileUrl),fileUrl&&fileUrl.length>0&&(wavesurfer.on("ready",function(){audioDuration=wavesurfer.getDuration(),$("#wave-content").animate({opacity:1},250,function(){wavesurfer.play(),loaded=!0}),$("#wave-loading").fadeOut(250)}),wavesurfer.on("audioprocess",function(e){audioProcess=e,frameProcess=Math.round(15*audioProcess)}),wavesurfer.on("seek",function(e){audioProcess=audioDuration*e,frameProcess=Math.round(15*audioProcess)}),wavesurfer.on("play",function(){$("#wave-play").attr("title","Pause").attr("data-original-title","Pause").find(".text").text("Pause").end().find(".fa").removeClass("fa-play").addClass("fa-pause")}),wavesurfer.on("pause",function(){$("#wave-play").attr("title","Play").attr("data-original-title","Play").find(".text").text("Play").end().find(".fa").removeClass("fa-pause").addClass("fa-play")}),wavesurfer.load(fileUrl))}},initButtons=function(){$("#wave-step-backward").click(function(){loaded&&wavesurfer.skipBackward()}),$("#wave-play").click(function(){loaded&&wavesurfer.playPause()}),$("#wave-stop").click(function(){loaded&&wavesurfer.stop()}),$("#wave-step-forward").click(function(){loaded&&wavesurfer.skipForward()}),$("#wave-set-marker").click(function(){if(loaded)if(null===markerRegion){var e=audioDuration-1;if(e>audioProcess){$(this).find(".text").text("Remove marker");var a={start:audioProcess,end:e};markerRegion=wavesurfer.addRegion(a),console.log("Marker set to:",markerRegion)}}else markerRegion.remove(),markerRegion=null,$(this).find(".text").text("Set marker")}),$("#wave-play-from-marker").click(function(){if(loaded)if(markerRegion){var e=markerRegion.start/audioDuration;wavesurfer.seekTo(e),wavesurfer.play()}else $("#set-marker-first-error").modal("show")}),$("#wave-save").click(function(){if(loaded){$("#text-sort").click();var e=[];$("#text-manager tbody tr").each(function(){var a=$(this),o=a.find("input.frame").val(),t=a.find("input.text").val();if(o&&o.length>0&&t&&t.length>0){var n=o+"|"+t;e.push(n)}});var a=e.join("\n");$.post(fileUrl,{content:a},function(){reloadPage()})}}),$("#wave-delete").click(function(){loaded&&$("#delete-file").modal("show")}),$("#delete-file-confirm").click(function(){$.ajax({url:fileUrl,type:"DELETE",success:function(e){reloadPage()}})}),$("#wave-decrease-volume").click(function(){$("#decrease-volume-modal").modal("show")}),$("#decrease-volume-confirm").click(function(){$.post("decrease-volume"+fileUrl,null,function(){reloadPage()})}),$("#wave-increase-volume").click(function(){$("#increase-volume-modal").modal("show")}),$("#increase-volume-confirm").click(function(){$.post("increase-volume"+fileUrl,null,function(){reloadPage()})})},updateInfoArea=function(){if(loaded){var e=[];audioProcess&&(e.push(audioProcess.toFixed(2)),e.push("("+frameProcess+")"),e.push("/")),e.push(audioDuration.toFixed(2)),e.push("- Pending files: "+fileCount);var a=e.join(" ");(null==lastInfoText||lastInfoText!=a)&&(lastInfoText=a,infoArea.text(a))}},initTooltips=function(){$(function(){$('[data-toggle="tooltip"]').tooltip()})},initLogsPage=function(){$("#clear-logs").click(function(){return $("#clear-logs-modal").modal("show"),!1}),$("#clear-logs-confirm").click(function(){$.ajax({url:"/logs",type:"DELETE",success:function(e){reloadPage()}})})},initTextManager=function(){var e=$(window).height();$("#text-wrapper").css("maxHeight",e-572),$("#text-manager").on("click",".arrow-up",function(){var e=$(this),a=e.parents("tr"),o=a.prev();o.length>0&&a.insertBefore(o)}).on("click",".arrow-down",function(){var e=$(this),a=e.parents("tr"),o=a.next();o.length>0&&a.insertAfter(o)}).on("click",".arrow-left",function(){var e=$(this),a=e.parents("tr"),o=a.find("input.frame");o.val(pad(frameProcess,4))}).on("click",".delete",function(){var e=$(this),a=e.parents("tr"),o=a.parents("tbody"),t=o.find("tr");t.length>1?a.remove():a.find("input").val("")}).on("blur","input.frame",function(){var e=$(this);e.val(pad(Math.abs(parseInt(e.val())),4))}).on("blur keydown keyup keypress","input.text",function(){var e=$(this);e.val(e.val().replace(/\|/g,""))}),$("#text-add").click(function(){var e=$("#text-manager tbody"),a=e.find("tr:first-child"),o=a.clone();o.find("input").val(""),o.appendTo(e),o.find("input").last().focus().end().first().val(pad(frameProcess,4))}),$("#text-clear").click(function(){$("#clear-texts").modal("show")}),$("#text-sort").click(function(){$("#text-manager tbody tr").sort(function(e,a){var o=$(e),t=$(a),n=o.find(".frame"),i=t.find(".frame");return parseInt(n.val())>parseInt(i.val())?1:-1}).appendTo("#text-manager tbody")}),$("#text-clear-confirm").click(function(){$("#text-manager tbody tr").find("input").val("").end().not(":first-child").remove(),$("#clear-texts").modal("hide")})},getVideoPathForClickedButton=function(e){var a=e.parents("tr"),o=a.find(".path"),t=o.text();return t},initVideoList=function(){$("#video-list").on("click",".download",function(){console.log("Download button pressed");var e=$(this),a=getVideoPathForClickedButton(e);location.href="/download/"+a}).on("click",".play",function(){console.log("Play button pressed");var e=$(this),a=getVideoPathForClickedButton(e),o=$("#video-target");o.find("video").remove();var t=$("<video></video>").addClass("embed-responsive-item").attr("controls","controls").attr("autoplay","autoplay"),n=$("<source></source>").attr("type","video/"+videoFileExtension.replace(".","")).attr("src",a);n.appendTo(t),t.appendTo(o),$("#play-video").modal("show")}).on("click",".delete",function(){var e=$(this),a=getVideoPathForClickedButton(e);videoUrl=a,$("#delete-video").modal("show")}),$("#delete-video-confirm").click(function(){console.log("Delete button pressed: ",videoUrl),$.ajax({url:videoUrl,type:"DELETE",success:function(e){reloadPage()}})}),$("#play-video").on("click","button",function(){console.log("Footer button pressed");var e=$("#video-target video");console.log("Videos: ",e),e&&e.length>0&&(e[0].paused||e[0].pause())})},pad=function(e,a){for(var o=e+"";o.length<a;)o="0"+o;return o},reloadPage=function(){console.log("Page reload scheduled"),window.setTimeout(function(){console.log("Reloading page"),location.reload()},1e3)};