...
#
*   * * * * root sleep 12;  sh process_volumne.sh
*   * * * * root sleep 27;  sh process_volumne.sh
*   * * * * root sleep 42;  sh process_volumne.sh
*   * * * * root sleep 57;  sh process_volumne.sh

#
# Will process the records every minute
*   * * * * root sleep 5;   sh process-records.sh

#
# Will create images for every frame every 5 minutes
#
*/5 * * * * root            sh create-frame-images.sh

#
# Will render videos every 5 minutes
#
*/5 * * * * root sleep 300; sh generate-video.sh
